...
assert.eq r6 false;
assert.eq r5 aleo17pmtmh8t7zwh0qfj8z0cmg0rqt4rtg4t85dy5ldrst5u0c4yvufq3gl9lf;
...
cast aleo1mnldqsfrwayzfep3t9zusu4y7yknsdhfwx76v5pajla35mrqn5xsvvurhy r1 aleo1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq3ljyzc r0 into r3 as ComplianceRecord.record;
...
cast aleo1mnldqsfrwayzfep3t9zusu4y7yknsdhfwx76v5pajla35mrqn5xsvvurhy r1 r0.owner aleo1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq3ljyzc into r4 as ComplianceRecord.record;
...
input r1 as u128.public;
cast r0 r1 into r2 as Token.record;
cast aleo1mnldqsfrwayzfep3t9zusu4y7yknsdhfwx76v5pajla35mrqn5xsvvurhy r1 self.caller r0 into r3 as ComplianceRecord.record;
...
cast aleo1mnldqsfrwayzfep3t9zusu4y7yknsdhfwx76v5pajla35mrqn5xsvvurhy r2 r0 r1 into r6 as ComplianceRecord.record;
...
cast aleo1mnldqsfrwayzfep3t9zusu4y7yknsdhfwx76v5pajla35mrqn5xsvvurhy r1 r2.owner r0 into r416 as ComplianceRecord.record;
...
sub r2.amount r1 into r413;
cast r2.owner r413 into r414 as Token.record;
cast aleo1mnldqsfrwayzfep3t9zusu4y7yknsdhfwx76v5pajla35mrqn5xsvvurhy r1 r2.owner r0 into r415 as ComplianceRecord.record;
...
cast aleo1mnldqsfrwayzfep3t9zusu4y7yknsdhfwx76v5pajla35mrqn5xsvvurhy r1 r2.owner r0 into r7 as ComplianceRecord.record;
...
function update_token_info:
input r0 as u128.public;
input r1 as u128.public;
input r2 as u128.public;
async update_token_info r0 r1 r2 self.caller into r3;
output r3 as test_usdcx_stablecoin.aleo/update_token_info.future;

finalize update_token_info:
input r0 as u128.public;
input r1 as u128.public;
input r2 as u128.public;
input r3 as address.public;
get address_to_role[r3] into r4;
is.eq r4 8u16 into r5;
assert.eq r5 true;
get token_info[true] into r6;
cast r0 r1 r6.decimals r6.supply r2 into r7 as TokenInfo;
set r7 into token_info[true];

constructor:
is.eq edition 0u16 into r0;
branch.eq r0 false to end_then_0_10;
assert.eq program_owner aleo17pmtmh8t7zwh0qfj8z0cmg0rqt4rtg4t85dy5ldrst5u0c4yvufq3gl9lf;
...
leo execute test_usdcx_stablecoin.aleo/transfer_public_to_private \
 aleo1awc7l4v56ahsjyj29g4fe3f8ps4w3akzy305vymlzm3exawgvypqk78elv 1000000u128 \
 --broadcast --yes
