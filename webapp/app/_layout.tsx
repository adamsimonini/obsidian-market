...
// Theme variables matching your global.css
...
export default function RootLayout() {
  ...
  // Convert theme variables to React Native styles using vars() dynamically
  const themeStyle = useMemo(() => {
    const currentTheme = nativewindColorScheme ?? 'light';
    const themeVars = themesVariables[currentTheme] ?? themesVariables.light;
